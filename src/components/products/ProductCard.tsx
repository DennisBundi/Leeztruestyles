...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  const handleWhatsAppShare = (e: React.MouseEvent) => {
    ...
    const link = WhatsAppService.generateProductInquiryLink(product.name, url, displayPrice || undefined);
      ...
      <div className="p-3 sm:p-4 md:p-5">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 py-2 sm:py-2.5 md:py-3 px-3 sm:px-4 rounded-none text-xs sm:text-sm md:text-base font-semibold transition-all duration-200 ${
              isOutOfStock
          ...
          <button
            ...
            className="flex-shrink-0 w-10 sm:w-11 flex items-center justify-center bg-[#25D366] text-white hover:bg-[#1DA851] active:scale-[0.96] transition-all duration-200"
          >
