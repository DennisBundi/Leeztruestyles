...
// Dummy inventory data for preview
const dummyInventory = [
  ...
  },
  {
    ...
    available: 3,
    category: 'Shoes',
    last_updated: new Date(Date.now() - 259200000),
  },
];
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        ...
        {filteredInventory.length !== dummyInventory.length && (
          <div className="mt-4 text-sm text-gray-600">
            Showing {filteredInventory.length} of {dummyInventory.length} products
          </div>
        )}
      </div>
